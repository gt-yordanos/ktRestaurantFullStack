...
class Updater {
    ...
    public function fetchTableData($tableName, $primaryKey, $primaryKeyValue) {
        $sql = "SELECT * FROM $tableName WHERE $primaryKey='$primaryKeyValue'";
        $result = $this->conn->query($sql);
        return $result->fetch_assoc();
    }

    public function updateTableData($tableName, $primaryKey, $primaryKeyValue, $data, $userRole) {
        $setClause = '';
...
if (isset($_GET['table']) && isset($_GET['id']) && isset($_GET['role'])) {
    ...
    $tableData = $updater->fetchTableData($tableName, $primaryKey, $primaryKeyValue);
    ...
    if ($tableData) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $redirectLocation = $updater->updateTableData($tableName, $primaryKey, $primaryKeyValue, $_POST, $userRole);
            if ($redirectLocation) {
